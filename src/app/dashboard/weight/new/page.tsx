...
export default function NewWeightPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    time: convert24HourTo12Hour(new Date().toTimeString().slice(0, 5)),
    notes: "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to save weight record:', errorData);
        alert(`Failed to save weight record: ${errorData.error || 'Unknown error'}`);
      }
    } catch (error) {
    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Log your weight and height for BMI tracking</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Record your weight and height for accurate BMI calculation
            </CardDescription>
          </CardHeader>
